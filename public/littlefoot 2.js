! function (e, t) {
  ...
  var z = {
    ...
    buttonTemplate: '<button class="littlefoot-footnote__button littlefoot-footnote__button__ellipsis" id="<% reference %>" title="See Footnote <% number %>" aria-expanded="false"><svg class="littlefoot-footnote__button__dots" role="img" aria-labelledby="title-<% reference %>" viewbox="0 0 31 6" preserveAspectRatio="xMidYMid"><title id="title-<% reference %>">Footnote <% number %></title><circle r="3" cx="3" cy="3" ></circle><circle r="3" cx="15" cy="3" ></circle><circle r="3" cx="27" cy="3" ></circle></svg></button>'
  };
